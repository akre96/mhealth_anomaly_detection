"""_summary_ Sim Experiment 06: How do anomaly detectors perform on point anomalies vs those incorporated into future data?
...
WINDOW_SIZES = [14]
N_FEATURES = 5
ANOMALY_TYPES = ["point", "rolling"]
KEY_DIFFERENCE = "anomaly_type"
...
def run_ad_on_simulated(
    ...
    if anomaly_type == "point":
        simulator = simulate_daily.BaseDailyDataSimulator(
        ...
        data = simulator.addPointAnomalies(
            ...
            anomaly_period=anomaly_frequency,
            anomaly_std_scale=2,
        )
    else:
